...
#
# # Tell the supported locales. This is the one of additional setting by
# Ruby-Locale for Ruby on Rails.
# # If supported_locales is not set, the locale information which is given by
# WWW browser is used.
# # This setting is required if your application wants to restrict the locales.
I18n.supported_locales = Dir[ File.join(RAILS_ROOT, 'lib', 'locale', '*.{rb,yml}') ].collect{|v| File.basename(v, ".*")}.uniq if I18n.respond_to?(:supported_locales=)
#
