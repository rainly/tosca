...
#
class IssueReferenceSweeper < ActionController::Caching::Sweeper
  ...
  def expire_cache_for(record)
    # Expire cache for both linked issues
    expire_fragments(record.issue.fragments)
    expire_fragments(record.linked_issue.fragments)
  end
end
